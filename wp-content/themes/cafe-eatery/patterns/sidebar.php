...
<figure class="wp-block-image size-large"><img src="<?php echo get_parent_theme_file_uri( '/assets/images/service2.jpg' ); ?>" alt="" class="wp-image-1831" style="aspect-ratio:1;object-fit:cover"/></figure>
<!-- /wp:image -->

<!-- wp:image {"id":1830,"aspectRatio":"1","scale":"cover","sizeSlug":"large","linkDestination":"none"} -->
<figure class="wp-block-image size-large"><img src="<?php echo get_parent_theme_file_uri( '/assets/images/service3.jpg' ); ?>" alt="" class="wp-image-1830" style="aspect-ratio:1;object-fit:cover"/></figure>
<!-- /wp:image -->
